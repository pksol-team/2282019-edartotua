							...
							<div class="container">
								...
								<div class="row">
									<div class="col-xs-12 all_elements">
										...
										<div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent" style=" padding: 0 !important;">
											<?php
											...
											<div class="tab-pane fade <?php if($element_group['ORDER_ID'] == 1) echo 'show active'; ?>" id="<?= $href; ?>" role="tabpanel" aria-labelledby="<?= $id; ?>" style="color: black;">
												<div class="ui-widget ui-helper-clearfix">
													<ul class="gallery ui-helper-reset ui-helper-clearfix" id="sortable" style="height: 60.8vh;
    padding: 0 !important;">
														<?php
															$index = 0;
																			...
																			while ($fetch_parameters = mysqli_fetch_array($fetch_parameters_value)) :
																				...
																				if($fetch_parameters['PARAM_TYPE'] === 'INTEGER') { ?>
																					...
																					<div class="form-group" data-field-type='integer'>
																					   ...
																					   <input type="number" name="<?= $fetch_parameters['PARAM_NAME'] ?>" class="form-control form-control-sm" placeholder="<?= encodes($fetch_parameters['TEXT']); ?>" value="<?= $fetch_parameters['DEFAULT_PARAM']; ?>" disabled>
																					</div>
															...
															?>
																...
																<li class="ui-widget-content ui-corner-tr ui-state-default paramsmeters d-sort door_image_li" data-tooltip-content="#tab_one_content-<?= $indexx; ?>" data-element-append="<?= $id; ?>" data-title="<?= $fetching_omc['ELEMENT_NAME']; ?>" style="display: none;">
																	...
																	<?php if ($fetching_omc['ELEMENT_NAME'] == 'SEQ'): ?>
																		...
																		<img src="<?= $fetching_omc['IMAGE_URL']; ?>?time=<?= time(); ?>" alt="<?= $fetching_omc['ELEMENT_NAME']; ?>" width="96" class="img-responsive"  >
																				...
																				while ($fetch_parameters = mysqli_fetch_array($fetch_parameters_value)) :
																					...
																					if($fetch_parameters['PARAM_TYPE'] === 'INTEGER') { ?>
																						...
																						<div class="form-group" data-field-type='integer'>
																						   ...
																						   <input type="number" name="<?= $fetch_parameters['PARAM_NAME'] ?>" class="form-control form-control-sm" placeholder="<?= $param_label; ?>" value="<?= $fetch_parameters['DEFAULT_PARAM']; ?>" disabled>
																						</div>
															...
															<td style="margin-left: 25px; ">
																<ul class="trash_dont_accept">
																	<li class="dashed_image_li d-sort">
																		...
																		?>
																		<div class="dashed-div-2 "> <div style="overflow: hidden; height: 62px; font-size: 11px; text-align: center; color: #85c6da;"><?= ucwords($add_new_b); ?><h3 class="row_design">+</h3></div> </div>
																	</li>
																	<!-- <li class="dashed_image_li d-sort">
																		<p style="font-size: 12px">DASHED iMAGE</p>
																		<?php
					...
					<div class="col-sm-12">
						...
						?>
						<button type="button" class="btn build-next" style="float: left;">  <span><?= encodes(mysqli_fetch_assoc($strategy_summary_text)['TEXT']); ?></span> </button>
						<br>
